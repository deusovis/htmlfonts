...
try:
    ...
    top_guides = [
        ...
        ("how-to-bold-text-in-html", "How to Bold Text in HTML", "Font Weights", "Instead of using the outdated bold tag, use the CSS font-weight property. A weight of 400 is standard, 700 is bold, and 900 is black.", "font-weight: 700;", "Only import the font weights you actually use to save bandwidth."),
        ...
        ("rem-vs-em-css-guide", "REM vs EM: Which CSS Unit is Best?", "Relative Sizing", "EMs compound based on their parent elements, which can lead to unpredictable sizes. REMs always scale relative to the root HTML element.", "padding: 2rem;\nfont-size: 1.125rem;", "Set your browser default to 100% and use REMs for all typography."),
        ("how-to-change-line-height-in-css", "Improving Readability with Line Height", "Vertical Rhythm", "Line-height controls the vertical space between lines. The golden rule for body copy is a line-height between 1.4 and 1.6.", "p {\n  line-height: 1.6;\n}", "Never use fixed pixel values for line-height; always use unitless multipliers."),
        ...
        ("best-fonts-for-mobile-apps", "The Best Fonts for Mobile App UI", "Interface Design", "Mobile screens require fonts with highly legible numerals, distinct geometry, and excellent rendering at small sizes.", "font-family: 'Roboto', 'San Francisco', sans-serif;", "Rely on the native OS fonts for the most native feel."),
...
<body class="bg-slate-50 min-h-screen flex flex-col font-sans selection:bg-indigo-200 selection:text-indigo-900">
    ...
    print(f"✅ Master Guides Page generated with {len(top_guides)} items.")
...
<body class="bg-slate-50 min-h-screen flex flex-col font-sans selection:bg-indigo-200 selection:text-indigo-900">
    ...
    print(f"✅ Build Successful: Created 30 Guides, 30 Comparisons, and Editor Archive.")
